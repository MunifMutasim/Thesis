...
public class OptionPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextField3.setText(""+DhakaSimFrame.pixelPerStrip);

        jTextField4.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jTextField4.setText(""+DhakaSimFrame.pixelPerFootpathStrip);
        ...
        jRadioButton1.setSelected(DhakaSimFrame.pedestrainmode);
        jRadioButton1.setText("On");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setFont(new java.awt.Font("Consolas", 0, 14)); // NOI18N
        jRadioButton2.setSelected(!DhakaSimFrame.pedestrainmode);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DhakaSimFrame.pixelPerStrip = Integer.parseInt(jTextField3.getText());
        DhakaSimFrame.pixelPerFootpathStrip = Integer.parseInt(jTextField4.getText());
        DhakaSimFrame.pixelPerMeter = Integer.parseInt(jTextField5.getText());
        DhakaSimFrame.encounterPerAccident = Integer.parseInt(jTextField6.getText());
        ...
        DhakaSimFrame.maximumSpeed = Double.parseDouble(jTextField9.getText());
        DhakaSimFrame.pedestrainmode = jRadioButton1.isSelected();       
        DhakaSimPanel dhakaSimPanel = new DhakaSimPanel(dhakaSimFrame);
        dhakaSimPanel.setScale(1);
        JSlider jSlider = new JSlider(JSlider.VERTICAL, 0, 300, 100);
        jSlider.addChangeListener(new ChangeListener() {
            public void stateChanged(ChangeEvent ce) {
                JSlider tmp = (JSlider) ce.getSource();
                dhakaSimPanel.setScale(Math.max(0.00001, tmp.getValue() / 100.0));
            }
        });
